// Shared data module - used by both API route and page component
// This demonstrates the data structure while keeping API routes functional
...
export type HeroData = typeof siteData.hero;
export type PromoData = typeof siteData.promos[number];
export type FeatureData = typeof siteData.features[number];
export type DestinationData = typeof siteData.destinations[number];
export type AdventureHighlightData = typeof siteData.adventureHighlights[number];
